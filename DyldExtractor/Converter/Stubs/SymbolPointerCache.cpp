...
template class Converter::Stubs::SymbolPointerCache<Utils::Arch::arm>;
template class Converter::Stubs::SymbolPointerCache<Utils::Arch::arm64>;
template class Converter::Stubs::SymbolPointerCache<Utils::Arch::arm64_32>;
